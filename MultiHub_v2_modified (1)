...
if not isfolder("Multi Hub") then
    makefolder("Multi Hub")
end
if not isfolder("Multi Hub/Config") then
    makefolder("Multi Hub/Config")
end
...
local ConfigFile = "Multi Hub/Config/Multi_" .. gameName .. ".json"
...
function CircleClick(Button, X, Y)
    spawn(function()
        ...
        Circle.Image = "rbxassetid://87438095913950"
...
local MultiHub = {}
function MultiHub:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "Multi Hub"
    ...
    spawn(function()
        ...
        if not CoreGui.NotifyGui:FindFirstChild("NotifyLayout") then
            ...
            NotifyLayout.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
function multihub(msg, delay, color, title, desc)
    return MultiHub:MakeNotify({
        Title = title or "Multi Hub",
...
function MultiHub:Window(GuiConfig)
    GuiConfig              = GuiConfig or {}
    GuiConfig.Title        = GuiConfig.Title or "Multi Hub"
    GuiConfig.Footer       = GuiConfig.Footer or "Multi Hub :3"
    ...
    MultiHub.ResetOnSpawn = false
    MultiHub.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = MultiHub

    DropShadowHolder.Position = UDim2.new(0, (MultiHub.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (MultiHub.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    LayersTab.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    DecideFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    LayersReal.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("MultiHub") then
            MultiHub:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        DialogGlow.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        ...
        Yes.MouseButton1Click:Connect(function()
            if MultiHub then MultiHub:Destroy() end
    ...
    function Tabs:AddTab(TabConfig)
        ...
        ScrolLayers.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        ...
        FeatureImg.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            SectionReal.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            SectionDecideFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            SectionAdd.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function Items:AddParagraph(ParagraphConfig)
                ...
                ParagraphTitle.TextColor3 = Color3.fromRGB(0, 0, 0)
                ...
                if ParagraphConfig.ButtonText then
                    ...
                    ParagraphButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function Items:AddPanel(PanelConfig)
                ...
                ButtonMain.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                if PanelConfig.SubButtonText then
                    ...
                    SubButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function Items:AddToggle(ToggleConfig)
                ...
                ToggleTitle2.TextColor3 = Color3.fromRGB(0, 0, 0)
                ...
                function ToggleFunc:Set(Value)
                    ...
                    if Value then
                        ...
                        TweenService:Create(UIStroke8, TweenInfo.new(0.2),
                            { Color = Color3.fromRGB(0, 0, 0), Transparency = 0.9 }):Play()
                        TweenService:Create(FeatureFrame2, TweenInfo.new(0.2),
                            { BackgroundColor3 = Color3.fromRGB(0, 0, 0), BackgroundTransparency = 0.92 }):Play()
                    end
                end
            ...
            function Items:AddSlider(SliderConfig)
                ...
                SliderContent.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function Items:AddInput(InputConfig)
                ...
                InputTitle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                InputContent.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                ...
                InputTextBox.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function Items:AddDropdown(DropdownConfig)
                ...
                OptionImg.ImageColor3 = Color3.fromRGB(0, 0, 0)
                ...
                function DropdownFunc:AddOption(option)
                    ...
                    OptionText.TextColor3 = Color3.fromRGB(0, 0, 0)
